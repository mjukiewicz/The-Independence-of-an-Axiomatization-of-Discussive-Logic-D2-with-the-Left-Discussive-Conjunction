...
def matrix_generator(first_element, second_element=0, third_element=0, fourth_element=0):
    numbers_list=[0]*9
    # with open("v2_step3.txt") as file1:
    #     for line1 in file1:
    ...
    for i in range(3**len(numbers_list)):
        ...
        for j in range(len(numbers_list)-1,-1,-1):
            if numbers_list[j]==3:
                numbers_list[j]=0
                numbers_list[j-1]+=1
        yield numbers_list #[second_element, third_element, fourth_element]+  line1+first_element+
    return
...
def main(first_element, second_element=0, third_element=0, fourth_element=0):
    ...
    for i in matrix_generator(first_element, second_element, third_element, fourth_element):
        ...
        z+=1
        values_to_check=i
        # negation_dic={0:values_to_check[9], 1:values_to_check[10], 2:values_to_check[11]
        #               }

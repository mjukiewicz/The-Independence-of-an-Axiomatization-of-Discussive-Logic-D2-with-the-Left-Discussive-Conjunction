            ...
            for i in range(3**len(numbers_list)):
                ...
                for j in range(len(numbers_list)-1,-1,-1):
                    if numbers_list[j]==3:
                        numbers_list[j]=0
                        numbers_list[j-1]+=1
                yield line1+first_element+numbers_list #[second_element, third_element, fourth_element]+
    return
...
def main(first_element, second_element=0, third_element=0, fourth_element=0):
    ...
    for i in matrix_generator(first_element, second_element, third_element, fourth_element):
        ...
        for indx, element in enumerate(dataset):
            ...
            # if n_inccorect>=2: break #do odkomentowania !!!!!!!!!!!!!!!
        if n_inccorect==0 and values_to_check[21]==0 and values_to_check[23]==2 and values_to_check[27]==2 and values_to_check[29]==2:
